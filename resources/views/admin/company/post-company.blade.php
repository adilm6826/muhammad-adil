    ...
    <main class="container mt-5 mb-5 mx-auto">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{route('home.companies.list_companies')}}">Company</a></li>
                <li class="breadcrumb-item active" aria-current="page">Post Comapny</li>
            </ol>
        </nav>
        <div class="jumbotron">
        ...
        <div class="row">
            <div class="col-md-10">
                ...
                @endif
                <form action="{{ route('home.companies.store_company') }}" method="POST" id="comapny_form">
                    @csrf
                    <div class="form-group mb-1">
                        <label for="name">Company Name</label>
                        <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" placeholder="Enter Your Company Name here:">
                    </div>
                    @error('name')
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="url" class="form-control" id="website" name="website" value="{{ old('website') }}" placeholder="Enter Your Company Website here:">
                    </div>
                    @error('website')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
