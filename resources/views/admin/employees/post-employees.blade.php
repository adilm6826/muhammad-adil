    ...
    <main class="container mt-5 mb-5 mx-auto">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{route('home.employees.list_employee')}}">Employees</a></li>
        ...
        <div class="row">
            <div class="col-md-10">
                ...
                @endif
                <form action="{{ route('home.employees.store_employee') }}" method="POST" id="employee_form">
                    @csrf
                    {{-- Begin: Employee First Name Here --}}
                    <div class="form-group mb-1">
                        <label for="fname">First Name</label>
                        <input type="text" class="form-control" id="fname" name="fname" value="{{ old('fname') }}" maxlength="255" placeholder="Enter Your First Name here:">
                    </div>
                    @error('fname')
                    ...
                    <div class="form-group mb-1">
                        ...
                        <input type="text" class="form-control" id="lname" name="lname" value="{{ old('lname') }}" maxlength="255" placeholder="Enter Your Last Name here:">
                    </div>
                    @error('lname')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                    ...
                    <div class="form-group mb-1">
                        ...
                        <input type="email" class="form-control" id="email" name="email" value="{{ old('email') }}" placeholder="Enter Your Company Email here:">
                    </div>
                    @error('email')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                    ...
                    <div class="form-group mb-1">
                        ...
                        <div class="input-group" id="phone_div">
                            ...
                            <input type="tel" class="form-control" id="phone" name="phone" pattern="[0-9]{9}" maxlength="9" minlength="9" value="{{old('phone')}}" placeholder="Enter Your Mobile Number Here:" >
                        </div>
